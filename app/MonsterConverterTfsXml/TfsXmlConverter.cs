...
namespace MonsterConverterTfsXml
{
    ...
    public class TfsXmlConverter : MonsterConverter
    {
        ...
        private readonly BiDictionary<string, Effect> magicEffectNames = new BiDictionary<string, Effect>
        {
            ...
            {"bonecapsule", Effect.RagiazBoneCapsule},
            {"criticaldamage", Effect.CriticalDamage},
            {"plungingfish", Effect.PlungingFish},
            {"bluechain", Effect.BlueChain},
            {"orangechain", Effect.OrangeChain},
            {"greenchain", Effect.GreenChain},
            {"purplechain", Effect.PurpleChain},
            {"greychain", Effect.GreyChain},
            {"yellowchain", Effect.YellowChain},
            {"yellowsparkles", Effect.YellowSparkles},
            {"faeexplosion", Effect.FaeExplosion},
            {"faecoming", Effect.FaeComing},
            {"faegoing", Effect.FaeGoing},
            {"bigcloudssinglespace", Effect.BigCloudsSingleSpace},
            {"stonessinglespace", Effect.StonesSingleSpace},
            {"blueghost", Effect.BlueGhost},
            {"pointofinterest", Effect.PointOfInterest},
            {"mapeffect", Effect.MapEffect},
            {"pinkspark", Effect.PointOfInterestFound},
            {"greenfirework", Effect.GreenFirework},
            {"orangefirework", Effect.OrangeFirework},
            {"purplefirework", Effect.PurpleFirework},
            {"turquoisefirework", Effect.TurquoiseFirework},
            {"thecube", Effect.TheCube},
            {"drawink", Effect.BlackBlood},
            {"prismaticsparkles", Effect.PrismaticSparkles},
            {"thaian", Effect.Thaian},
            {"thaianghost", Effect.ThaianGhost},
            {"ghostsmoke", Effect.GhostSmoke},
            ...
            {"slash", Effect.Slash},
            {"bite", Effect.Bite},
            {"chivalriouschallenge", Effect.Challenge},
            {"divinedazzle", Effect.DivineDazzle},
            {"electricalspark", Effect.ElectricalSpark},
            {"purpleteleport", Effect.PurpleTeleport},
            {"redteleport", Effect.RedTeleport},
            {"orangeteleport", Effect.OrangeTeleport},
            {"greyteleport", Effect.GreyTeleport},
            {"lightblueteleport", Effect.LightBlueTeleport},
            ...
            {"devovorga", Effect.Devovorga},
            {"ferumbras2", Effect.Ferumbras2}
        };

        private readonly BiDictionary<string, Missile> shootTypeNames = new BiDictionary<string, Missile>
        {
            {"spear",               Missile.Spear},
            {"bolt",                Missile.Bolt},
            {"arrow",               Missile.Arrow},
            ...
            {"poisonarrow",         Missile.PoisonArrow},
            {"burstarrow",          Missile.BurstArrow},
            {"throwingstar",        Missile.ThrowingStar},
            {"throwingknife",       Missile.ThrowingKnife},
            {"smallstone",          Missile.SmallStone},
            {"death",               Missile.Death},
            {"largerock",           Missile.LargeRock},
            {"snowball",            Missile.Snowball},
            {"powerbolt",           Missile.PowerBolt},
            {"poison",              Missile.Poison},
            {"infernalbolt",        Missile.InfernalBolt},
            {"huntingspear",        Missile.HuntingSpear},
            {"enchantedspear",      Missile.EnchantedSpear},
            {"redstar",             Missile.RedStar},
            {"greenstar",           Missile.GreenStar},
            {"royalspear",          Missile.RoyalSpear},
            {"sniperarrow",         Missile.SniperArrow},
            {"onyxarrow",           Missile.OnyxArrow},
            {"piercingbolt",        Missile.PiercingBolt},
            {"whirlwindsword",      Missile.WhirlwindSword},
            {"whirlwindaxe",        Missile.WhirlwindAxe},
            {"whirlwindclub",       Missile.WhirlwindClub},
            {"etherealspear",       Missile.EtherealSpear},
            {"ice",                 Missile.Ice},
            {"earth",               Missile.Earth},
            {"holy",                Missile.Holy},
            {"suddendeath",         Missile.SuddenDeath},
            {"flasharrow",          Missile.FlashArrow},
            {"flammingarrow",       Missile.FlammingArrow},
            {"shiverarrow",         Missile.ShiverArrow},
            {"energyball",          Missile.EnergyBall},
            {"smallice",            Missile.SmallIce},
            {"smallholy",           Missile.SmallHoly},
            {"smallearth",          Missile.SmallEarth},
            {"eartharrow",          Missile.EarthArrow},
            {"explosion",           Missile.Explosion},
            {"cake",                Missile.Cake},
            {"tarsalarrow",         Missile.TarsalArrow},
            {"vortexbolt",          Missile.VortexBolt},
            {"prismaticbolt",       Missile.PrismaticBolt},
            {"crystallinearrow",    Missile.CrystallineArrow},
        ...
        private static void SummonGenericToTfsXml(Monster monster, XElement monsterElement)
        {
        ...
        private static void LootGenericToTfsXml(IList<LootItem> items, XElement monsterElement)
        {
