namespace MonsterConverterTibiaWiki
{
    ...
    class InfoboxCreatureTemplate
    {
        ...
        [TemplateParameter(Index = 26, Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        ...
        [TemplateParameter(Index = 44, Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        ...
        [TemplateParameter(Index = 46, Name = "hpDrainDmgMod", Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        ...
        [TemplateParameter(Index = 52, Name = "race_id", Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        public string raceid { get; set; }

        [TemplateParameter(Index = 53, Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        public string notes { get; set; }

        [TemplateParameter(Index = 54, Name = "behaviour", Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        ...
        [TemplateParameter(Index = 58, Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
        public string location { get; set; }

        [TemplateParameter(Index = 59, Required = ParameterRequired.No, Indicator = ParameterIndicator.Name)]
